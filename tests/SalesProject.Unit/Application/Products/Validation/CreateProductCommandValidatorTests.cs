...
public class CreateProductCommandValidatorTests
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CreateProductCommandValidatorTests"/> class.
    /// </summary>
    ...
    /// <summary>
    /// Tests that a valid create product command passes validation.
    /// </summary>
    ...
    public void Validate_EmptyName_ShouldHaveValidationError()
    {
        ...
        result.Errors.Should().Contain(error =>
            error.PropertyName == nameof(CreateProductCommand.Name) &&
    ...
    public void Validate_ZeroCurrentPrice_ShouldHaveValidationError()
    {
        ...
        result.Errors.Should().Contain(error =>
            error.PropertyName == nameof(CreateProductCommand.CurrentPrice) &&
    ...
    public void Validate_UnknownStatus_ShouldHaveValidationError()
    {
        ...
        result.Errors.Should().Contain(error =>
            error.PropertyName == nameof(CreateProductCommand.Status));
    }
