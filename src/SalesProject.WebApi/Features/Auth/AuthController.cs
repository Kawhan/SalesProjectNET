...
using SalesProject.Application.Auth.AuthenticateUser;
using SalesProject.WebApi.Common;
using SalesProject.WebApi.Features.Auth.AuthenticateUserFeature;

namespace SalesProject.WebApi.Features.Auth;
